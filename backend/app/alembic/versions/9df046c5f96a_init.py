...
Revision ID: 9df046c5f96a
Revises: 
Create Date: 2022-02-07 21:13:09.308265
...
def upgrade():
    ...
    op.create_index(op.f('ix_refresh_session_refresh_token'), 'refresh_session', ['refresh_token'], unique=True)
